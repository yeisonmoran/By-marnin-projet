...
<head>
  ...
  <style>
    body {
      background: linear-gradient(135deg, #c480bbff 0%, #995a6dff 50%, #cf209bff 100%);
      min-height: 100vh;
    }
    ...
    .login-card-header {
      background: linear-gradient(135deg, #ea66c2ff 0%, #e25ea4ff 100%);
      padding: 2.5rem 2rem;
      text-align: center;
    }
    ...
    .btn-login {
      background: linear-gradient(135deg, #ff00eaff 0%, #e60adbff 100%);
      border: none;
      border-radius: 8px;
      padding: .75rem;
      font-size: 1rem;
    ...
    .btn-login:hover {
      ...
      box-shadow: 0 8px 20px rgba(255, 0, 140, 0.5);
    }
  ...
  <div class="container" style="max-width:440px; padding-top:8vh">
    <div class="login-card">
      <div class="login-card-header">
        <div class="brand-icon"><img src="/tienda_by_marnin/assets/img/logo.png" alt="By Marnin"
            style="width:200px; height:200px; border-radius:50%; object-fit:cover; border:3px solid rgba(0, 0, 0, 0.5);">
        </div>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="email" name="correo" id="correo" class="form-control"
                value="<?= isset($_POST['correo']) ? htmlspecialchars($_POST['correo']) : '' ?>" required autofocus>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <div class="input-group-append">
                <span class="input-group-text"
                  style="cursor:pointer; border:2px solid #ffffffff; border-left:none; border-radius:0 8px 8px 0;"
                  onclick="togglePass()">
