  ...
  <div class="container" style="max-width:600px; padding:6vh 1rem 2rem">
    <div class="reg-card">
      <div class="reg-card-header">
        <img src="/tienda_by_marnin/assets/img/logo.png" alt="By Marnin"
          style="width:200px; height:200px; border-radius:50%; object-fit:cover; border:3px solid rgba(255,255,255,0.5);">
        ...
        <form method="POST">
          <div class="row">
            ...
            <div class="col-md-6 form-group">
              ...
              <input type="password" name="confirmar" class="form-control" placeholder="Repita la contraseña" required
                minlength="6">
            </div>
            <div class="col-md-6 form-group">
              <label><b>Rol</b></label>
            ...
            <div class="col-md-6 form-group">
              ...
              <select name="id_tipo_documento" class="form-control" required>
                ...
                <?php while ($t = $tipos->fetch_assoc()): ?>
                  <option value="<?= $t['id_tipo_documento'] ?>">(<?= $t['abreviatura'] ?>)
